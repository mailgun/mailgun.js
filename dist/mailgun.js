      ...
      if ('attachment' === key || 'inline' === key) {
        ...
        if (Array.isArray(obj)) {
          obj.forEach(function (item) {
            var data = isStream(item) ? item : item.data;
