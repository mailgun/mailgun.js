// mailgun.js v8.2.2 Copyright (c) 2023 Mailgun and contributors
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define(factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Mailgun = factory());
    ...
    ***************************************************************************** */
    ...
    values[45] = 62;
    values[95] = 63;
    function b64Length(byteCount, padding) {
    ...
    function encode$2(data, url, padding) {
      ...
      for (let i = 0; i < byteCount; i++) {
        switch (i % 3) {
          case 0:
            b64Buffer[bi++] = chars[(data[i] & 252) >> 2];
            tmp = (data[i] & 3) << 4;
            break;
          case 1:
            b64Buffer[bi++] = chars[tmp | (data[i] & 240) >> 4];
            tmp = (data[i] & 15) << 2;
            break;
          case 2:
            b64Buffer[bi++] = chars[tmp | (data[i] & 192) >> 6];
            b64Buffer[bi++] = chars[data[i] & 63];
        }
      }
      switch (byteCount % 3) {
        case 1:
    ...
    function base64Encode(data, padding = true) {
      return encode$2(data, false, padding);
    }
    ...
    class FormDataBuilder {
        ...
        isNodeFormData(formDataInstance) {
            return formDataInstance.getHeaders !== undefined;
        }
        getAttachmentOptions(item) {
            if (typeof item !== 'object' || this.isStream(item))
                return {};
            const { filename, contentType, knownLength } = item;
            return Object.assign(Object.assign(Object.assign({}, (filename ? { filename } : { filename: 'file' })), (contentType && { contentType })), (knownLength && { knownLength }));
        }
        addMimeDataToFD(key, data, formDataInstance) {
            if (Buffer.isBuffer(data) || typeof data === 'string') {
                ...
                const browserFormData = formDataInstance;
                browserFormData.append(key, data, 'MimeMessage');
            }
        }
        addFilesToFD(propertyName, value, formDataInstance) {
            const appendFileToFD = (originalKey, obj, formData) => {
    ...
    class Request {
        ...
        request(method, url, onCallOptions) {
            var _a, _b, _c;
            return __awaiter(this, void 0, void 0, function* () {
                const options = Object.assign({}, onCallOptions);
                ...
                try {
                    response = yield axios$1.request(Object.assign(Object.assign({ method: method.toLocaleUpperCase(), timeout: this.timeout, url: urlValue, headers: requestHeaders }, params), { maxBodyLength: this.maxBodyLength }));
                }
                catch (err) {
                ...
                const res = yield this.getResponseBody(response);
                return res;
            });
        }
        ...
        query(method, url, query, options) {
            return this.request(method, url, Object.assign({ query }, options));
        }
        command(method, url, data, options, addDefaultHeaders = true) {
            ...
            const requestOptions = Object.assign(Object.assign(Object.assign({}, headers), { body: data }), options);
    ...
    class DomainClient {
        ...
        create(data) {
            const postObj = Object.assign({}, data);
        ...
        updateTracking(domain, type, data) {
            if (typeof (data === null || data === void 0 ? void 0 : data.active) === 'boolean') {
                throw new APIError({ status: 400, statusText: 'Received boolean value for active property', body: { message: 'Property "active" must contain string value.' } });
            }
    ...
    class NavigationThruPages {
        ...
        requestListWithPages(clientUrl, query, Model) {
            return __awaiter(this, void 0, void 0, function* () {
                const { url, updatedQuery } = this.updateUrlAndQuery(clientUrl, query);
                if (this.request) {
                    const response = yield this.request.get(url, updatedQuery);
    ...
    class SuppressionClient extends NavigationThruPages {
        ...
        parseList(response, Model) {
            var _a;
            const data = {};
            data.items = ((_a = response.body.items) === null || _a === void 0 ? void 0 : _a.map((item) => new Model(item))) || [];
    ...
    class MessagesClient {
        ...
        _parseResponse(response) {
            return Object.assign({ status: response.status }, response.body);
        }
        create(domain, data) {
            if (data.message) {
    ...
    class ValidateClient {
        ...
        get(address) {
            return __awaiter(this, void 0, void 0, function* () {
                const query = { address };
                const result = yield this.request.get('/v4/address/validate', query);
                return result.body;
            });
        }
    }
    ...
    class IpsClient {
        ...
        list(query) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.get('/v3/ips', query);
                return this.parseIpsResponse(response);
            });
        }
        get(ip) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.get(`/v3/ips/${ip}`);
                return this.parseIpsResponse(response);
            });
        }
    ...
    class IpPoolsClient {
        ...
        create(data) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.postWithFD('/v1/ip_pools', data);
                return Object.assign({ status: response.status }, response.body);
            });
        }
        update(poolId, data) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.patchWithFD(`/v1/ip_pools/${poolId}`, data);
                return Object.assign({ status: response.status }, response.body);
            });
        }
        delete(poolId, data) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.delete(`/v1/ip_pools/${poolId}`, data);
                return Object.assign({ status: response.status }, response.body);
            });
        }
    ...
    class ListsClient extends NavigationThruPages {
        ...
        parseValidationResult(status, data) {
            return {
                status,
                validationResult: Object.assign(Object.assign({}, data), { created_at: new Date(data.created_at * 1000) // add millisecond to Unix timestamp
                 })
            };
        }
        parseList(response) {
        ...
        validate(mailListAddress) {
            return this.request.post(`${this.baseRoute}/${mailListAddress}/validate`, {})
                .then((response) => (Object.assign({ status: response.status }, response.body)));
        }
    ...
    class MultipleValidationClient extends NavigationThruPages {
        ...
        handleResponse(response) {
            return Object.assign({ status: response.status }, response === null || response === void 0 ? void 0 : response.body);
        }
        parseList(response) {
            const data = {};
        ...
        get(listId) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.get(`/v4/address/validate/bulk/${listId}`);
                return new MultipleValidationJob(response.body, response.status);
            });
        }
        create(listId, data) {
            return __awaiter(this, void 0, void 0, function* () {
                const multipleValidationData = Object.assign({ multipleValidationFile: Object.assign({}, data === null || data === void 0 ? void 0 : data.file) }, data);
                delete multipleValidationData.file;
                const response = yield this.request.postWithFD(`/v4/address/validate/bulk/${listId}`, multipleValidationData);
                return this.handleResponse(response);
            });
        }
        destroy(listId) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.request.delete(`/v4/address/validate/bulk/${listId}`);
                return this.handleResponse(response);
            });
        }
    }
    ...
    class DomainTagStatistic {
        constructor(tagStatisticInfo) {
            ...
            this.stats = tagStatisticInfo.body.stats.map(function (stat) {
                const res = Object.assign(Object.assign({}, stat), { time: new Date(stat.time) });
                return res;
            });
        }
    }
    ...
    class Client {
        constructor(options, formData) {
            ...
            this.domains = new DomainClient(this.request, domainCredentialsClient, domainTemplatesClient, domainTagsClient);
