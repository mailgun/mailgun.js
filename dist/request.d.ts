...
declare class Request {
    ...
    command(method: string, url: string, data?: Record<string, unknown> | Record<string, unknown>[] | string | NodeFormData, options?: Record<string, unknown>, addDefaultHeaders?: boolean): Promise<APIResponse>;
