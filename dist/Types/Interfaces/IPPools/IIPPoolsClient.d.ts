import { IpPoolCreateData, IpPoolCreateResult, IpPoolDeleteData, IpPoolDetails, IpPoolLinkedDomains, IpPoolLinkedDomainsQuery, IpPoolListResult, IpPoolMessageResult, IpPoolUpdateData, IpPoolUpdateResult } from '../../Types/IPPools/index.js';
export interface IIPPoolsClient {
    ...
    removeIpFromDomainPool(domain: string, ip: string, replacementPoolId?: string): Promise<IpPoolMessageResult>;
