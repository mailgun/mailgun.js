...
- [CustomFile](modules.md#customfile)
- [CustomFileData](modules.md#customfiledata)
...
- [DomainDynamicPropsType](modules.md#domaindynamicpropstype)
- [DomainEvent](modules.md#domainevent)
- [DomainGetQuery](modules.md#domaingetquery)
...
- [DomainResponseData](modules.md#domainresponsedata)
...
- [FormDataInput](modules.md#formdatainput)
- [FormDataInputValue](modules.md#formdatainputvalue)
- [FormDataOptions](modules.md#formdataoptions)
- [GenerateDomainTrackingCertificateResponse](modules.md#generatedomaintrackingcertificateresponse)
- [GetDomainTemplateAPIResponse](modules.md#getdomaintemplateapiresponse)
- [GetDomainTrackingCertificateResponse](modules.md#getdomaintrackingcertificateresponse)
...
- [JsonComposite](modules.md#jsoncomposite)
- [JsonObject](modules.md#jsonobject)
- [JsonPrimitive](modules.md#jsonprimitive)
...
- [MailingListResult](modules.md#mailinglistresult)
...
- [MessageAttachment](modules.md#messageattachment)
...
- [MimeMessage](modules.md#mimemessage)
...
- [RegenerateDomainTrackingCertificateResponse](modules.md#regeneratedomaintrackingcertificateresponse)
...
- [UpdatedDKIMSelectorResult](modules.md#updateddkimselectorresult)
...
[Types/Common/Error.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/Error.ts#L1)
...
[Types/Common/Error.ts:13](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/Error.ts#L13)
...
[Types/Common/ApiResponse.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/ApiResponse.ts#L1)
...
[Types/Webhooks/Webhooks.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L1)
...
[Types/Messages/Messages.ts:7](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L7)
...
| Name | Type |
| :------ | :------ |
| `encrypt_incoming_message` | [`DomainInfo`](modules.md#domaininfo)[``"encrypt_incoming_message"``] |
| `force_dkim_authority` | [`DomainInfo`](modules.md#domaininfo)[``"force_dkim_authority"``] |
| `force_root_dkim_host` | [`DomainInfo`](modules.md#domaininfo)[``"force_root_dkim_host"``] |
| `use_automatic_sender_security` | [`DomainInfo`](modules.md#domaininfo)[``"use_automatic_sender_security"``] |
| `wildcard` | [`DomainInfo`](modules.md#domaininfo)[``"wildcard"``] |

#### Defined in

[Types/Domains/Domains.ts:43](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L43)
...
[Types/Suppressions/Bounce.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Bounce.ts#L2)
...
[Types/Validations/MultipleValidation.ts:91](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L91)
...
[Types/Domains/DomainTracking.ts:40](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L40)
...
[Types/Suppressions/Complaint.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Complaint.ts#L2)
...
[Types/Domains/Domains.ts:112](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L112)
...
| Name | Type |
| :------ | :------ |
| `body` | [`ConnectionSettings`](modules.md#connectionsettings) |
| `status` | `number` |

#### Defined in

[Types/Domains/Domains.ts:116](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L116)
...
[Types/Domains/DomainTemplates.ts:60](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L60)
...
[Types/Domains/DomainTemplates.ts:122](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L122)
...
[Types/Domains/DomainTemplates.ts:130](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L130)
...
[Types/MailingLists/MailingLists.ts:10](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L10)
...
[Types/MailingLists/MailingListMembers.ts:29](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L29)
...
[Types/MailingLists/MailingListMembers.ts:37](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L37)
...
[Types/Routes/Routes.ts:20](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Routes/Routes.ts#L20)
...
[Types/Validations/MultipleValidation.ts:60](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L60)
...
[Types/Domains/DomainCredentials.ts:36](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L36)
...
| :------ | :------ |
| `contentType?` | `string` |
| `data` | [`CustomFileData`](modules.md#customfiledata) |
| `filename?` | `string` |
| `knownLength?` | `number` |

#### Defined in

[Types/Messages/Messages.ts:19](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L19)
...
[Types/Messages/Messages.ts:17](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L17)
...
[Types/Domains/Domains.ts:132](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L132)
...
[Types/Domains/Domains.ts:147](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L147)
...
[Types/Domains/DomainCredentials.ts:43](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L43)
...
[Types/MailingLists/MailingListMembers.ts:45](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L45)
...
[Types/Routes/Routes.ts:15](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Routes/Routes.ts#L15)
...
[Types/Domains/Domains.ts:107](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L107)
...
[Types/MailingLists/MailingLists.ts:18](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L18)
...
[Types/Domains/DomainTags.ts:176](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L176)
...
[Types/Domains/DomainTags.ts:185](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L185)
...
[Types/Domains/DomainCredentials.ts:7](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L7)
...
[Types/Domains/DomainCredentials.ts:12](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L12)
...
[Types/Domains/DomainCredentials.ts:26](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L26)
...
[Types/Domains/DomainCredentials.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L2)
...
[Types/Domains/DomainCredentials.ts:18](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L18)
...
[Types/Domains/DomainCredentials.ts:30](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L30)
...
[Types/Domains/Domains.ts:51](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L51)

___

### DomainDynamicPropsType

Ƭ **DomainDynamicPropsType**: `Pick`<[`DomainData`](modules.md#domaindata), ``"dkim_host"`` \| ``"mailfrom_host"``\>

#### Defined in

[Types/Domains/Domains.ts:200](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L200)
...
[Types/Events/Events.ts:38](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Events/Events.ts#L38)
...
[Types/Domains/Domains.ts:202](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L202)

___

### DomainInfo

Ƭ **DomainInfo**: [`DomainUpdateInfo`](modules.md#domainupdateinfo) & { `dkim_host_name?`: `string` ; `dkim_key_size?`: ``1024`` \| ``2048`` ; `dkim_selector?`: `string` ; `encrypt_incoming_message?`: `boolean` \| ``"true"`` \| ``"false"`` ; `force_dkim_authority?`: `boolean` \| ``"true"`` \| ``"false"`` ; `force_root_dkim_host?`: `boolean` \| ``"true"`` \| ``"false"`` ; `ips?`: ``""`` ; `name`: `string` ; `pool_id?`: ``""``  }

#### Defined in

[Types/Domains/Domains.ts:27](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L27)
...
[Types/Domains/Domains.ts:39](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L39)
...
[Types/Domains/Domains.ts:95](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L95)
...
[Types/Domains/Domains.ts:85](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L85)
...
[Types/Domains/DomainTags.ts:51](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L51)
...
[Types/Domains/DomainTags.ts:111](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L111)
...
[Types/Domains/DomainTags.ts:127](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L127)
...
[Types/Domains/DomainTags.ts:192](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L192)
...
[Types/Domains/DomainTags.ts:200](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L200)
...
[Types/Domains/DomainTags.ts:141](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L141)
...
[Types/Domains/DomainTags.ts:160](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L160)
...
[Types/Domains/DomainTags.ts:97](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L97)
...
[Types/Domains/DomainTags.ts:107](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L107)
...
[Types/Domains/DomainTags.ts:25](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L25)
...
[Types/Domains/DomainTags.ts:18](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L18)
...
[Types/Domains/DomainTags.ts:40](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L40)
...
[Types/Domains/DomainTags.ts:46](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L46)
...
[Types/Domains/DomainTags.ts:5](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L5)
...
[Types/Domains/DomainTags.ts:32](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L32)
...
[Types/Domains/DomainTags.ts:10](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTags.ts#L10)
...
[Types/Domains/DomainTemplates.ts:6](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L6)
...
[Types/Domains/DomainTemplates.ts:23](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L23)
...
[Types/Domains/DomainTemplates.ts:27](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L27)
...
[Types/Domains/DomainTemplates.ts:15](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L15)
...
[Types/Domains/DomainTemplates.ts:33](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L33)
...
[Types/Domains/DomainTracking.ts:3](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L3)
...
[Types/Domains/DomainTracking.ts:13](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L13)
...
[Types/Domains/Domains.ts:11](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L11)

___

### DomainUpdateInfoReq

Ƭ **DomainUpdateInfoReq**: `Omit`<[`DomainUpdateInfo`](modules.md#domainupdateinfo), ``"message_ttl"``\> & { `use_automatic_sender_security?`: ``"true"`` \| ``"false"`` ; `wildcard?`: ``"true"`` \| ``"false"``  }

#### Defined in

[Types/Domains/Domains.ts:22](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L22)
...
[Types/Domains/Domains.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L2)
...
[Types/Events/Events.ts:92](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Events/Events.ts#L92)
...
[Types/Events/Events.ts:3](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Events/Events.ts#L3)
...
[Types/Events/Events.ts:24](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Events/Events.ts#L24)
...
[Types/Events/Events.ts:31](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Events/Events.ts#L31)
...
[Types/Events/Events.ts:9](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Events/Events.ts#L9)
...
▪ [key: `string`]: [`FormDataInputValue`](modules.md#formdatainputvalue)

#### Defined in

[Types/Common/FormData.ts:16](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/FormData.ts#L16)

___

### FormDataInputValue

Ƭ **FormDataInputValue**: [`MimeMessage`](modules.md#mimemessage) \| [`CustomFileData`](modules.md#customfiledata) \| `string` \| `string`[] \| `boolean` \| [`MessageAttachment`](modules.md#messageattachment) \| `undefined` \| `number` \| [`JsonObject`](modules.md#jsonobject)

#### Defined in

[Types/Messages/Messages.ts:36](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L36)
...
[Types/Common/FormData.ts:4](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/FormData.ts#L4)
...
[Types/Domains/DomainTracking.ts:57](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L57)
...
[Types/Domains/DomainTemplates.ts:87](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L87)
...
[Types/Domains/DomainTracking.ts:50](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L50)
...
[Types/IPs/IPs.ts:14](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPs/IPs.ts#L14)

___

### InputFormData

Ƭ **InputFormData**: (`form?`: `HTMLFormElement`, `submitter?`: ``null`` \| `HTMLElement`) => `FormData` \| (`options?`: [`FormDataOptions`](modules.md#formdataoptions)) => `FormData`

#### Defined in

[Types/Common/FormData.ts:8](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/FormData.ts#L8)
...
[Types/IPs/IPs.ts:8](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPs/IPs.ts#L8)
...
[Types/IPPools/IpPools.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L2)
...
[Types/IPPools/IpPools.ts:47](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L47)
...
[Types/IPPools/IpPools.ts:53](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L53)
...
[Types/IPPools/IpPools.ts:61](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L61)
...
[Types/IPPools/IpPools.ts:42](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L42)
...
[Types/IPPools/IpPools.ts:10](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L10)
...
[Types/IPPools/IpPools.ts:18](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L18)
...
[Types/IPPools/IpPools.ts:30](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L30)
...
[Types/IPPools/IpPools.ts:37](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L37)
...
[Types/IPPools/IpPools.ts:24](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPPools/IpPools.ts#L24)
...
[Types/IPs/IPs.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/IPs/IPs.ts#L2)

___

### Json

Ƭ **Json**: [`JsonPrimitive`](modules.md#jsonprimitive) \| [`JsonComposite`](modules.md#jsoncomposite)

#### Defined in

[Types/Messages/Messages.ts:51](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L51)

___

### JsonArray

Ƭ **JsonArray**: [`Json`](modules.md#json)[]

#### Defined in

[Types/Messages/Messages.ts:48](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L48)

___

### JsonComposite

Ƭ **JsonComposite**: [`JsonArray`](modules.md#jsonarray) \| [`JsonObject`](modules.md#jsonobject)

#### Defined in

[Types/Messages/Messages.ts:50](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L50)
...
[Types/Messages/Messages.ts:49](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L49)
...
[Types/Messages/Messages.ts:47](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L47)
...
[Types/Domains/DomainTemplates.ts:158](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L158)
...
[Types/Domains/DomainTemplates.ts:173](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L173)
...
[Types/Domains/DomainTemplates.ts:68](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L68)
...
[Types/Domains/DomainTemplates.ts:81](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L81)
...
[Types/MailingLists/MailingLists.ts:4](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L4)
...
[Types/MailingLists/MailingListMembers.ts:4](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L4)
...
[Types/MailingLists/MailingListMembers.ts:13](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L13)
...
[Types/MailingLists/MailingListMembers.ts:58](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L58)
...
[Types/MailingLists/MailingListMembers.ts:66](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L66)
...
[Types/MailgunClient/MailgunClientOptions.ts:3](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailgunClient/MailgunClientOptions.ts#L3)

___

### MailgunMessageContent

Ƭ **MailgunMessageContent**: [`AtLeastOneKeyPresent`](modules.md#atleastonekeypresent)<{ `html?`: `string` ; `message?`: [`MimeMessage`](modules.md#mimemessage) ; `template?`: `string` ; `text?`: `string`  }\>

#### Defined in

[Types/Messages/Messages.ts:53](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L53)

___

### MailgunMessageData

Ƭ **MailgunMessageData**: [`MailgunMessageContent`](modules.md#mailgunmessagecontent) & { `[key: string]`: [`FormDataInputValue`](modules.md#formdatainputvalue); `amp-html?`: `string` ; `attachment?`: [`MessageAttachment`](modules.md#messageattachment) ; `bcc?`: `string` \| `string`[] ; `cc?`: `string` \| `string`[] ; `from?`: `string` ; `h:X-My-Header?`: `string` ; `inline?`: `any` ; `o:deliverytime?`: `string` ; `o:deliverytime-optimize-period?`: `string` ; `o:dkim?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `o:require-tls?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `o:skip-verification?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `o:tag?`: `string` \| `string`[] ; `o:testmode?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `o:time-zone-localize?`: `string` ; `o:tracking?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `o:tracking-clicks?`: `boolean` \| ``"yes"`` \| ``"no"`` \| ``"htmlonly"`` ; `o:tracking-opens?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `recipient-variables?`: `string` ; `subject?`: `string` ; `t:text?`: `boolean` \| ``"yes"`` \| ``"no"`` ; `t:variables?`: `string` \| [`JsonObject`](modules.md#jsonobject) ; `t:version?`: `string` ; `to?`: `string` \| `string`[] ; `v:my-var?`: `string`  }

#### Defined in

[Types/Messages/Messages.ts:73](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L73)
...
[Types/MailingLists/MailingLists.ts:69](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L69)
...
[Types/MailingLists/MailingLists.ts:85](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L85)
...
[Types/MailingLists/MailingLists.ts:65](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L65)
...
[Types/MailingLists/MailingLists.ts:79](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L79)
...
[Types/MailingLists/MailingLists.ts:54](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L54)
...
[Types/MailingLists/MailingLists.ts:29](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L29)
...
[Types/MailingLists/MailingLists.ts:60](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L60)
...
[Types/MailingLists/MailingLists.ts:57](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L57)

___

### MessageAttachment

Ƭ **MessageAttachment**: [`CustomFile`](modules.md#customfile) \| [`CustomFile`](modules.md#customfile)[] \| `File` \| `File`[] \| `string` \| [`CustomFileData`](modules.md#customfiledata) \| [`CustomFileData`](modules.md#customfiledata)[]

#### Defined in

[Types/Messages/Messages.ts:27](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L27)
...
[Types/Domains/Domains.ts:103](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L103)
...
[Types/Messages/Messages.ts:244](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L244)
...
[Types/Messages/Messages.ts:252](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L252)
...
[Types/Messages/Messages.ts:16](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Messages/Messages.ts#L16)
...
[Types/MailingLists/MailingListMembers.ts:19](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L19)
...
[Types/MailingLists/MailingListMembers.ts:24](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L24)
...
| Name | Type |
| :------ | :------ |
| `file` | [`CustomFileData`](modules.md#customfiledata) \| [`CustomFile`](modules.md#customfile) |

#### Defined in

[Types/Validations/MultipleValidation.ts:64](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L64)
...
| Name | Type |
| :------ | :------ |
| `multipleValidationFile` | [`CustomFileData`](modules.md#customfiledata) \| [`CustomFile`](modules.md#customfile) |

#### Defined in

[Types/Validations/MultipleValidation.ts:67](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L67)
...
[Types/Validations/MultipleValidation.ts:5](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L5)
...
[Types/Validations/MultipleValidation.ts:32](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L32)
...
[Types/Validations/MultipleValidation.ts:78](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L78)
...
[Types/Validations/MultipleValidation.ts:83](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L83)
...
[Types/Validations/MultipleValidation.ts:71](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/MultipleValidation.ts#L71)
...
[Types/Domains/DomainTemplates.ts:136](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L136)
...
[Types/Domains/DomainTemplates.ts:149](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L149)
...
[Types/MailingLists/MailingListMembers.ts:52](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingListMembers.ts#L52)
...
[Types/Domains/DomainTemplates.ts:110](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L110)
...
[Types/Domains/DomainTemplates.ts:117](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L117)
...
[Types/Common/RequestOptions.ts:4](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/RequestOptions.ts#L4)
...
[Types/Common/RequestOptions.ts:12](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/RequestOptions.ts#L12)
...
[Types/Domains/DomainTracking.ts:36](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L36)
...
[Types/Common/NavigationThruPages.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L1)
...
[Types/Common/NavigationThruPages.ts:22](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L22)
...
[Types/Common/NavigationThruPages.ts:8](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L8)
...
[Types/Common/NavigationThruPages.ts:15](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L15)
...
[Types/Common/NavigationThruPages.ts:32](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L32)
...
[Types/Domains/DomainTracking.ts:63](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L63)
...
[Types/Domains/Domains.ts:172](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L172)
...
[Types/Common/RequestOptions.ts:7](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/RequestOptions.ts#L7)
...
[Types/Common/NavigationThruPages.ts:26](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L26)
...
[Types/Routes/Routes.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Routes/Routes.ts#L2)
...
[Types/Routes/Routes.ts:27](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Routes/Routes.ts#L27)
...
[Types/Domains/DomainTemplates.ts:46](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L46)
...
[Types/MailingLists/MailingLists.ts:23](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/MailingLists/MailingLists.ts#L23)
...
[Types/Stats/Stats.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Stats/Stats.ts#L1)
...
[Types/Stats/Stats.ts:17](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Stats/Stats.ts#L17)
...
[Types/Stats/Stats.ts:10](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Stats/Stats.ts#L10)
...
[Types/Stats/Stats.ts:19](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Stats/Stats.ts#L19)
...
[Types/Subaccounts/Subaccounts.ts:8](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Subaccounts/Subaccounts.ts#L8)
...
[Types/Subaccounts/Subaccounts.ts:14](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Subaccounts/Subaccounts.ts#L14)
...
[Types/Subaccounts/Subaccounts.ts:19](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Subaccounts/Subaccounts.ts#L19)
...
[Types/Subaccounts/Subaccounts.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Subaccounts/Subaccounts.ts#L1)
...
[Types/Suppressions/Suppressions.ts:57](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L57)
...
[Types/Suppressions/Suppressions.ts:67](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L67)
...
[Types/Suppressions/Suppressions.ts:76](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L76)
...
[Types/Suppressions/Suppressions.ts:26](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L26)
...
[Types/Suppressions/Suppressions.ts:41](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L41)
...
[Types/Suppressions/Suppressions.ts:50](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L50)
...
| Name | Type |
| :------ | :------ |
| `items` | ([`IBounce`](interfaces/Interfaces.IBounce.md) \| [`IComplaint`](interfaces/Interfaces.IComplaint.md) \| [`IUnsubscribe`](interfaces/Interfaces.IUnsubscribe.md) \| [`IWhiteList`](interfaces/Interfaces.IWhiteList.md))[] |
| `pages` | [`ParsedPagesList`](modules.md#parsedpageslist) |
| `status` | `number` |

#### Defined in

[Types/Suppressions/Suppressions.ts:15](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L15)
...
[Types/Suppressions/Suppressions.ts:21](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L21)
...
| Name | Type |
| :------ | :------ |
| `body` | { `items`: [`BounceData`](modules.md#bouncedata)[] \| [`ComplaintData`](modules.md#complaintdata)[] \| [`UnsubscribeData`](modules.md#unsubscribedata)[] \| [`WhiteListData`](modules.md#whitelistdata)[] ; `paging`: [`PagesList`](modules.md#pageslist)  } |
| `body.items` | [`BounceData`](modules.md#bouncedata)[] \| [`ComplaintData`](modules.md#complaintdata)[] \| [`UnsubscribeData`](modules.md#unsubscribedata)[] \| [`WhiteListData`](modules.md#whitelistdata)[] |
| `body.paging` | [`PagesList`](modules.md#pageslist) |
| `status` | `number` |

#### Defined in

[Types/Suppressions/Suppressions.ts:28](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L28)
...
| Name | Type |
| :------ | :------ |
| `body` | [`SuppressionDataType`](modules.md#suppressiondatatype) |
| `status` | `number` |

#### Defined in

[Types/Suppressions/Suppressions.ts:36](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Suppressions.ts#L36)
...
| `message?` | `string` |
| `name` | `string` |
| `receiving_dns_records` | [`DNSRecord`](interfaces/DNSRecord.md)[] \| ``null`` |
| `require_tls` | `boolean` |
| `sending_dns_records` | [`DNSRecord`](interfaces/DNSRecord.md)[] \| ``null`` |
| `skip_verification` | `boolean` |
| `smtp_login` | `string` |
| `smtp_password` | `string` |
| `spam_action` | `string` |
...
[Types/Domains/Domains.ts:177](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L177)
...
[Types/Domains/DomainTemplates.ts:42](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L42)

___

### TemplateVersion

Ƭ **TemplateVersion**: [`ShortTemplateVersion`](modules.md#shorttemplateversion) & { `template`: `string`  }

#### Defined in

[Types/Domains/DomainTemplates.ts:56](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L56)
...
[Types/Suppressions/Unsubscribe.ts:2](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/Unsubscribe.ts#L2)
...
[Types/Domains/DomainTracking.ts:44](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L44)
...
[Types/Domains/DomainCredentials.ts:51](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainCredentials.ts#L51)
...
| Name | Type |
| :------ | :------ |
| `body` | [`UpdatedOpenTracking`](modules.md#updatedopentracking) |
| `status` | `number` |

#### Defined in

[Types/Domains/DomainTracking.ts:31](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L31)
...
[Types/Domains/DomainTemplates.ts:94](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L94)
...
[Types/Domains/DomainTemplates.ts:104](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTemplates.ts#L104)

___

### UpdateRouteResponse

Ƭ **UpdateRouteResponse**: [`Route`](modules.md#route) & { `message`: `string`  }

#### Defined in

[Types/Routes/Routes.ts:11](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Routes/Routes.ts#L11)
...
[Types/Domains/Domains.ts:121](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L121)
...
| Name | Type |
| :------ | :------ |
| `body` | [`UpdatedConnectionSettings`](modules.md#updatedconnectionsettings) |
| `status` | `number` |

#### Defined in

[Types/Domains/Domains.ts:127](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L127)
...
| `changed` | `boolean` |
| `message` | `string` |
| `sending_dns_records` | [`DNSRecord`](interfaces/DNSRecord.md)[] |

#### Defined in

[Types/Domains/Domains.ts:136](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L136)
...
| Name | Type |
| :------ | :------ |
| `body` | [`UpdatedDKIMAuthority`](modules.md#updateddkimauthority) |
| `status` | `number` |

#### Defined in

[Types/Domains/Domains.ts:142](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L142)
...
[Types/Domains/Domains.ts:151](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L151)

___

### UpdatedDKIMSelectorResult

Ƭ **UpdatedDKIMSelectorResult**: [`MessageResponse`](modules.md#messageresponse) & { `status`: `number`  }

#### Defined in

[Types/Domains/Domains.ts:156](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L156)
...
[Types/Domains/DomainTracking.ts:20](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/DomainTracking.ts#L20)
...
[Types/Common/NavigationThruPages.ts:36](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Common/NavigationThruPages.ts#L36)
...
[Types/Domains/Domains.ts:164](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L164)
...
[Types/Domains/Domains.ts:167](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L167)
...
[Types/Validations/Validation.ts:3](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/Validation.ts#L3)
...
| Name | Type |
| :------ | :------ |
| `body` | [`ValidationResult`](modules.md#validationresult) |
| `status` | `number` |

#### Defined in

[Types/Validations/Validation.ts:15](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/Validation.ts#L15)
...
[Types/Validations/Validation.ts:6](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Validations/Validation.ts#L6)
...
[Types/Domains/Domains.ts:160](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Domains/Domains.ts#L160)
...
[Types/Webhooks/Webhooks.ts:16](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L16)
...
| Name | Type |
| :------ | :------ |
| `body` | [`WebhookResponseBody`](modules.md#webhookresponsebody) |
| `status` | `number` |

#### Defined in

[Types/Webhooks/Webhooks.ts:11](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L11)
...
| :------ | :------ |
| `message` | `string` |
| `webhook` | [`APIWebhook`](modules.md#apiwebhook) |

#### Defined in

[Types/Webhooks/Webhooks.ts:6](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L6)
...
[Types/Webhooks/Webhooks.ts:32](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L32)
...
[Types/Webhooks/Webhooks.ts:27](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L27)
...
[Types/Webhooks/Webhooks.ts:22](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Webhooks/Webhooks.ts#L22)
...
[Types/Suppressions/WhiteList.ts:1](https://github.com/mailgun/mailgun.js/blob/ef6853f/lib/Types/Suppressions/WhiteList.ts#L1)
